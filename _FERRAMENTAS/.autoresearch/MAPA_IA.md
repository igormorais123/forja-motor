...
```mermaid
flowchart TD
  N407a7d99c7[".autoresearch<br/>pasta de caso/produção<br/>56 arquivos / 7 subpastas"]
  N708c99be94["subir: _FERRAMENTAS"]
  N407a7d99c7 --> N708c99be94
  click N708c99be94 "../MAPA_IA.md" "Abrir mapa superior"
  N279349cfb2["pipeline-visual-medina<br/>pasta organizadora<br/>52 arquivos"]
  N407a7d99c7 --> N279349cfb2
  click N279349cfb2 "pipeline-visual-medina/MAPA_IA.md" "Abrir mapa da pasta"
  Nb84b8d3add["template_qa_paginas<br/>artefatos técnicos<br/>1 arquivos"]
  N407a7d99c7 --> Nb84b8d3add
  click Nb84b8d3add "template_qa_paginas/MAPA_IA.md" "Abrir mapa da pasta"
  N152711ae7e["template_qa.pdf<br/>documento de trabalho ou entrega"]
  N407a7d99c7 --> N152711ae7e
  click N152711ae7e "template_qa.pdf" "Abrir arquivo"
```
