...
- Conteúdo recursivo: **1 arquivos**, **0 subpastas**, **102.2 KB**
- Tipos de arquivo: .png: 1
...
```mermaid
flowchart TD
  N236e016fbc["template_qa_paginas<br/>artefatos técnicos<br/>1 arquivos / 0 subpastas"]
  N2587a6c566["subir: .autoresearch"]
  N236e016fbc --> N2587a6c566
  click N2587a6c566 "../MAPA_IA.md" "Abrir mapa superior"
```
...
|---|---:|---:|---:|---|
| [p01.png](<p01.png>) | artefato técnico | 102.2 KB | 2026-07-08 04:46 | imagem/render de QA ou build |

## Leitura por papel

- **artefato técnico**: [p01.png](<p01.png>)
