...
Gerado em `2026-08-05T00:53:38-03:00`. Este documento é opinativo: distingue evidência observada, inferência arquitetural e proposta ainda não implementada.
...
- O escopo analisado contém **128 módulos**, **41206 linhas**, **45 módulos acima de 300 linhas**, **274 imports locais qualificados** e **0 ciclos reais de import**.
- **100 módulos** têm consumidor de teste direto. Isso mede acoplamento de teste observado, não cobertura de linhas.
