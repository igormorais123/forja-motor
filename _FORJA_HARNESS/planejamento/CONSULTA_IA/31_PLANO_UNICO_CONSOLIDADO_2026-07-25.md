# Consulta IA — 31 — Plano único consolidado: FORJA-ASSINATURA Lite + requisitos do titular

> Cópia de consulta derivada. O documento canônico permanece no caminho de origem indicado abaixo.

## Metadados e rastreabilidade

- **Documento de origem:** `31_PLANO_UNICO_CONSOLIDADO_2026-07-25.md`
- **Tipo:** Plano
- **SHA-256 da origem:** `83e0922de5a34a96a1181aec1da023e98b7ada874ac439d6abbe02a2869b5f25`
- **Linhas da origem:** 182
...
**Síntese de localização:** Data: 25/07/2026. Estado: planejamento consolidado. Nenhuma linha de código foi alterada.

**Termos de recuperação:** não, três, plano, titular, crítica, brief, dois, documento, existe, consulta, único, rotas.
...
- [SRC-S001 · L1–L12 · 31 — Plano único consolidado: FORJA-ASSINATURA Lite + requisitos do titular](#src-s001)
  ...
  - SHA-256 do bloco: `a995626083af8363f4512c19f3cc867ccff8bfb452fe35c8d4ae158b771ce81e`
  - [SRC-S002 · L13–L37 · 1. A descoberta que dispensa metade da obra](#src-s002)
    - Caminho: 31 — Plano único consolidado: FORJA-ASSINATURA Lite + requisitos do titular > 1. A descoberta que dispensa metade da obra
    ...
    - SHA-256 do bloco: `9cdcc2898a17329c32a905b1549261526e23f9d8c28ce1a2a3c6a18d1fa68b95`
  - [SRC-S003 · L38–L61 · 2. A dependência que a versão Lite não enxergou](#src-s003)
    - Caminho: 31 — Plano único consolidado: FORJA-ASSINATURA Lite + requisitos do titular > 2. A dependência que a versão Lite não enxergou
    ...
    - SHA-256 do bloco: `25849e8fccc124622aaad45e61c8463d936ccaa5c24dd6dacb3065f739ee4065`
  - [SRC-S004 · L62–L63 · 3. Superfície técnica única](#src-s004)
    - Caminho: 31 — Plano único consolidado: FORJA-ASSINATURA Lite + requisitos do titular > 3. Superfície técnica única
    - Assuntos: superfície, técnica, única
    - Trecho-guia: Documento de consulta sobre 3. Superfície técnica única.
    - SHA-256 do bloco: `c7c7c0347308cf45beb3de74964a4711bbdcb9178e189e0f6cbdbcf39bc8431a`
    - [SRC-S005 · L64–L75 · 3.1 Artefatos novos — dois, e não sete](#src-s005)
      - Caminho: 31 — Plano único consolidado: FORJA-ASSINATURA Lite + requisitos do titular > 3. Superfície técnica única > 3.1 Artefatos novos — dois, e não sete
      ...
      - SHA-256 do bloco: `a0c93fe9114fe91556d5639d850f23e80999239f87139b853150c097c5d97097`
    - [SRC-S006 · L76–L87 · 3.2 Extensões de artefatos existentes — três, sem schema novo](#src-s006)
      - Caminho: 31 — Plano único consolidado: FORJA-ASSINATURA Lite + requisitos do titular > 3. Superfície técnica única > 3.2 Extensões de artefatos existentes — três, sem schema novo
      ...
      - SHA-256 do bloco: `cff02c16ab76aeff787785ff1c2752c2be27e7f2eb89b10f15ff102b1f831075`
    - [SRC-S007 · L88–L97 · 3.3 Sem schema novo — um seletor e um renderizador](#src-s007)
      - Caminho: 31 — Plano único consolidado: FORJA-ASSINATURA Lite + requisitos do titular > 3. Superfície técnica única > 3.3 Sem schema novo — um seletor e um renderizador
      ...
      - SHA-256 do bloco: `7d5500ad48ece48ae23ba8d792a0e0a0cae72584ebd306e0c6ade40d1a41bed0`
    - [SRC-S008 · L98–L103 · 3.4 Configuração e prova](#src-s008)
      - Caminho: 31 — Plano único consolidado: FORJA-ASSINATURA Lite + requisitos do titular > 3. Superfície técnica única > 3.4 Configuração e prova
      ...
      - SHA-256 do bloco: `e6dbde73ea086851221e44752cb2313738ad5857bc1897a190896843920b5f3d`
  - [SRC-S009 · L104–L105 · 4. O que sai — de ambos os planos](#src-s009)
    - Caminho: 31 — Plano único consolidado: FORJA-ASSINATURA Lite + requisitos do titular > 4. O que sai — de ambos os planos
    - Assuntos: sai, ambos, planos
    - Trecho-guia: Documento de consulta sobre 4. O que sai — de ambos os planos.
    - SHA-256 do bloco: `62dbba97b98133aa26172a8b362b50d56712361b0a860ffcdddbd2f815823ede`
    - [SRC-S010 · L106–L111 · 4.1 Cortes no FORJA-ASSINATURA (endosso a crítica, com um acréscimo)](#src-s010)
      - Caminho: 31 — Plano único consolidado: FORJA-ASSINATURA Lite + requisitos do titular > 4. O que sai — de ambos os planos > 4.1 Cortes no FORJA-ASSINATURA (endosso a crítica, com um acréscimo)
      ...
      - SHA-256 do bloco: `345fd5928ba1c574f12fe9f8c644d2664b6c5fe18007aa948bb0545b22230d77`
    - [SRC-S011 · L112–L121 · 4.2 Cortes no meu plano (documento 30)](#src-s011)
      - Caminho: 31 — Plano único consolidado: FORJA-ASSINATURA Lite + requisitos do titular > 4. O que sai — de ambos os planos > 4.2 Cortes no meu plano (documento 30)
      ...
      - SHA-256 do bloco: `a205279baefa4b2003c28e1ea47fb742584ae0d95b9e6bff425842fc333ee37f`
    - [SRC-S012 · L122–L134 · 4.3 Placar da consolidação](#src-s012)
      - Caminho: 31 — Plano único consolidado: FORJA-ASSINATURA Lite + requisitos do titular > 4. O que sai — de ambos os planos > 4.3 Placar da consolidação
      ...
      - SHA-256 do bloco: `5afd1b358d7b2ac06fd9b11230ccdf8c5bc7fee2b7b39f6f38957394e6f70c26`
  - [SRC-S013 · L135–L148 · 5. Separação que a crítica embaçou: nem tudo é hipótese de A/B](#src-s013)
    - Caminho: 31 — Plano único consolidado: FORJA-ASSINATURA Lite + requisitos do titular > 5. Separação que a crítica embaçou: nem tudo é hipótese de A/B
    ...
    - SHA-256 do bloco: `2f5bdf60524874829091e9ad0e8e76bbc304aedd28d12062acfaf0c5300a2741`
  - [SRC-S014 · L149–L169 · 6. Três ondas](#src-s014)
    - Caminho: 31 — Plano único consolidado: FORJA-ASSINATURA Lite + requisitos do titular > 6. Três ondas
    ...
    - SHA-256 do bloco: `70b642b1deb34851c2a8afd0137bed3ad7673c9bfd9b92785ec4f391f4f947a3`
  - [SRC-S015 · L170–L179 · 7. Riscos que continuam de pé](#src-s015)
    - Caminho: 31 — Plano único consolidado: FORJA-ASSINATURA Lite + requisitos do titular > 7. Riscos que continuam de pé
    ...
    - SHA-256 do bloco: `7351b6c23262ec6291625253ba1bdd37d4b10e68fa908b1e1d8b9bae96dd38e0`
  - [SRC-S016 · L180–L182 · 8. O que continua dependendo dele](#src-s016)
    - Caminho: 31 — Plano único consolidado: FORJA-ASSINATURA Lite + requisitos do titular > 8. O que continua dependendo dele
    ...
    - SHA-256 do bloco: `ae7356e2271ed327a11e2a3a19bfd518fb159eeac5738ac089b41ac3131d1761`
