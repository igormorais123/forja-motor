# Consulta IA — Plano 43 — o que vale importar de davidondrej/skills para a fábrica e para a FORJA

> Cópia de consulta derivada. O documento canônico permanece no caminho de origem indicado abaixo.

## Metadados e rastreabilidade

- **Documento de origem:** `43_PLANO_SKILLS_IMPORTADAS_ONDREJ.md`
- **Tipo:** Plano
- **SHA-256 da origem:** `0688d3e08b2216b0dac8523c7ee85abab0558889a7f2266b44c9f33e0a437cc8`
- **Linhas da origem:** 112
- **Blocos integralmente indexados:** 13
...
**Síntese de localização:** Revisado em 05/08/2026. O PRD de execução deste plano é planejamento/44PRDSKILLSDISCIPLINASPROCESSO.md — requisitos R1-R9 com critério de aceite, rollout em três ondas e métricas. O item 5 abaixo foi corrigido após conferência no código.

**Termos de recuperação:** não, skills, skill, claude, fábrica, seis, plano, vale, onde, modelo, tem, gate.
...
- [SRC-S001 · L1–L11 · Plano 43 — o que vale importar de davidondrej/skills para a fábrica e para a FORJA](#src-s001)
  ...
  - SHA-256 do bloco: `87ad746355a0fa6ebf1564c065b8f7d05f456cf69e0951de06b3cea96e600ab3`
  - [SRC-S002 · L12–L13 · 1. Triagem das 47](#src-s002)
    - Caminho: Plano 43 — o que vale importar de davidondrej/skills para a fábrica e para a FORJA > 1. Triagem das 47
    - Assuntos: triagem
    - Trecho-guia: Documento de consulta sobre 1. Triagem das 47.
    - SHA-256 do bloco: `17b8d1f7eb49bd7e3345a627c109cc7407ae2944374b111b2006684044a904fe`
    - [SRC-S003 · L14–L17 · 1.1 Já instaladas por você, em versão pt-BR (não fazer nada)](#src-s003)
      - Caminho: Plano 43 — o que vale importar de davidondrej/skills para a fábrica e para a FORJA > 1. Triagem das 47 > 1.1 Já instaladas por você, em versão pt-BR (não fazer nada)
      ...
      - SHA-256 do bloco: `38f156db18fb5980290d3384dcdc2d855212f936d46581bdfd089d545b847384`
    - [SRC-S004 · L18–L35 · 1.2 Sem tradução para cá — descartadas com motivo](#src-s004)
      - Caminho: Plano 43 — o que vale importar de davidondrej/skills para a fábrica e para a FORJA > 1. Triagem das 47 > 1.2 Sem tradução para cá — descartadas com motivo
      ...
      - SHA-256 do bloco: `6a46cc8220fa7795b054f64d28b3ae7bb06317b663229d26bebad7e7ec808754`
    - [SRC-S005 · L36–L46 · 1.3 Adotadas — seis skills, escritas em .claude/skills/ da fábrica](#src-s005)
      - Caminho: Plano 43 — o que vale importar de davidondrej/skills para a fábrica e para a FORJA > 1. Triagem das 47 > 1.3 Adotadas — seis skills, escritas em .claude/skills/ da fábrica
      ...
      - SHA-256 do bloco: `52ca92bf23fe5a61344db180c91898c340967e59d44f80f52256e923c8a9ca5e`
  - [SRC-S006 · L47–L54 · 2. A ideia que mais importa](#src-s006)
    - Caminho: Plano 43 — o que vale importar de davidondrej/skills para a fábrica e para a FORJA > 2. A ideia que mais importa
    ...
    - SHA-256 do bloco: `d52b77e7bf496d534b241a6efab40a22f2a6bb58c18efb9b74abb61e9364cae7`
  - [SRC-S007 · L55–L67 · 3. Auditoria das skills existentes (não é skill nova)](#src-s007)
    - Caminho: Plano 43 — o que vale importar de davidondrej/skills para a fábrica e para a FORJA > 3. Auditoria das skills existentes (não é skill nova)
    ...
    - SHA-256 do bloco: `bddc1ffd5a2abd9cddb621a8351790b2ec3ab75f071a5ed8d5066fe7975f2188`
  - [SRC-S008 · L68–L69 · 4. Implementação](#src-s008)
    - Caminho: Plano 43 — o que vale importar de davidondrej/skills para a fábrica e para a FORJA > 4. Implementação
    - Assuntos: implementação
    - Trecho-guia: Documento de consulta sobre 4. Implementação.
    - SHA-256 do bloco: `2aa424f1b5d6dcff6332f1f7832d8aa1c87eacb7740de5eb46c019565c3d9ad6`
    - [SRC-S009 · L70–L73 · 4.1 Onde ficam](#src-s009)
      - Caminho: Plano 43 — o que vale importar de davidondrej/skills para a fábrica e para a FORJA > 4. Implementação > 4.1 Onde ficam
      ...
      - SHA-256 do bloco: `8c4b76e0972ea6474b3a008bb52cbb1f77f3d21e6087323a9ef93f1cfd4f51ef`
    - [SRC-S010 · L74–L84 · 4.2 Ligação com o que já roda — ordem sugerida](#src-s010)
      - Caminho: Plano 43 — o que vale importar de davidondrej/skills para a fábrica e para a FORJA > 4. Implementação > 4.2 Ligação com o que já roda — ordem sugerida
      ...
      - SHA-256 do bloco: `6e537ac44b8eaa64d10594af7735c56e49b8eba6adb1720fa8708bce7d81f08f`
    - [SRC-S011 · L85–L100 · 4.3 A divergência CLAUDE.md × AGENTS.md](#src-s011)
      - Caminho: Plano 43 — o que vale importar de davidondrej/skills para a fábrica e para a FORJA > 4. Implementação > 4.3 A divergência CLAUDE.md × AGENTS.md
      ...
      - SHA-256 do bloco: `920e442d28411e2f6057ee77d29de73b22662b07e8c10d7cffe012dea6c8bcbd`
  - [SRC-S012 · L101–L106 · 5. Observação sobre o modelo editorial (de fable-safe-prompt)](#src-s012)
    - Caminho: Plano 43 — o que vale importar de davidondrej/skills para a fábrica e para a FORJA > 5. Observação sobre o modelo editorial (de fable-safe-prompt)
    ...
    - SHA-256 do bloco: `486223fc781cbe2752a2e1a6bce78e295735bfc23794fda509e5a95b5be43952`
  - [SRC-S013 · L107–L112 · 6. O que este plano não faz](#src-s013)
    - Caminho: Plano 43 — o que vale importar de davidondrej/skills para a fábrica e para a FORJA > 6. O que este plano não faz
    ...
    - SHA-256 do bloco: `88fa7e1c9c60d6caa2d7e711325d53f0110947f68b4c60aeb8dc74c9a93f4b5a`
