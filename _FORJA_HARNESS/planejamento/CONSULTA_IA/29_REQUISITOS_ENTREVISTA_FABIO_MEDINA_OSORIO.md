# Consulta IA — 25 — Requisitos da FORJA extraídos da entrevista de Fábio Medina Osório

> Cópia de consulta derivada. O documento canônico permanece no caminho de origem indicado abaixo.

## Metadados e rastreabilidade

- **Documento de origem:** `29_REQUISITOS_ENTREVISTA_FABIO_MEDINA_OSORIO.md`
- **Tipo:** Entrevista e requisitos
- **SHA-256 da origem:** `289f07154400fbd14308c81b0a7680e61e37a534794aa50378109206f5d300ac`
- **Linhas da origem:** 314
- **Blocos integralmente indexados:** 21
...
**Síntese de localização:** Fonte: transcrição de áudio de entrevista conduzida por Igor Morais Vasconcelos (Participante 1) com Fábio Medina Osório (Participante 2), 48 minutos, recebida em 25/07/2026. Natureza deste documento: fonte canônica de requisitos declarados pelo titular. Substitui inferência sobre "o que o escritório quer" nos pontos aqui cobertos.

**Termos de recuperação:** não, literal, ele, ela, trabalho, pedido, têm, ser, mais, documento, três, precedente.
...
- [SRC-S001 · L1–L8 · 25 — Requisitos da FORJA extraídos da entrevista de Fábio Medina Osório](#src-s001)
  ...
  - SHA-256 do bloco: `880148d1eb70cdde355429de25dbcc1c484f41c47335cb47be648105a201bf09`
  - [SRC-S002 · L9–L22 · 0. Advertência de método (obrigatória antes de citar este documento)](#src-s002)
    - Caminho: 25 — Requisitos da FORJA extraídos da entrevista de Fábio Medina Osório > 0. Advertência de método (obrigatória antes de citar este documento)
    ...
    - SHA-256 do bloco: `6b3ae720268a70cbc89cbf1a1fca4ca9bf5e199fa1a389e07d90aa65f4a657ff`
  - [SRC-S003 · L23–L24 · 1. O que ele efetivamente pediu](#src-s003)
    - Caminho: 25 — Requisitos da FORJA extraídos da entrevista de Fábio Medina Osório > 1. O que ele efetivamente pediu
    - Assuntos: ele, efetivamente, pediu
    - Trecho-guia: Documento de consulta sobre 1. O que ele efetivamente pediu.
    - SHA-256 do bloco: `65859752266259789fc93a163f733e286c62e029e47352c380131aa120be0909`
    - [SRC-S004 · L25–L32 · 1.1 A tese central, dita por ele](#src-s004)
      - Caminho: 25 — Requisitos da FORJA extraídos da entrevista de Fábio Medina Osório > 1. O que ele efetivamente pediu > 1.1 A tese central, dita por ele
      ...
      - SHA-256 do bloco: `7a2dd4ab360ea2a3bd4efb603e654217af2e238e988b9285507b853d85cd40a9`
    - [SRC-S005 · L33–L47 · 1.2 A ordem de trabalho que ele descreveu](#src-s005)
      - Caminho: 25 — Requisitos da FORJA extraídos da entrevista de Fábio Medina Osório > 1. O que ele efetivamente pediu > 1.2 A ordem de trabalho que ele descreveu
      - Assuntos: literal, ela, pedido, trabalho, ele, documental, não, deve
      - Trecho-guia: Ele descreveu um procedimento, e a ordem importa:
      - SHA-256 do bloco: `63bd2e2c5ff279b88b24229216536a3d2e2b343c73ede25f679ac21b79402ac2`
    - [SRC-S006 · L48–L55 · 1.3 O argumento econômico dele, que precisa ser respeitado literalmente](#src-s006)
      - Caminho: 25 — Requisitos da FORJA extraídos da entrevista de Fábio Medina Osório > 1. O que ele efetivamente pediu > 1.3 O argumento econômico dele, que precisa ser respeitado literalmente
      ...
      - SHA-256 do bloco: `4b1b3356ecf49462fbe902ec4ce0975a0876eebc635e6b831531ac2276f6ae72`
    - [SRC-S007 · L56–L74 · 1.4 Topologia decisória — o algoritmo que ele ditou](#src-s007)
      - Caminho: 25 — Requisitos da FORJA extraídos da entrevista de Fábio Medina Osório > 1. O que ele efetivamente pediu > 1.4 Topologia decisória — o algoritmo que ele ditou
      ...
      - SHA-256 do bloco: `aef7ea0051aa7f2f75b14510150f5122d173a0a0448e12f0dd7525faab3df092`
    - [SRC-S008 · L75–L88 · 1.5 Estilo — três premissas declaradas, nesta ordem](#src-s008)
      - Caminho: 25 — Requisitos da FORJA extraídos da entrevista de Fábio Medina Osório > 1. O que ele efetivamente pediu > 1.5 Estilo — três premissas declaradas, nesta ordem
      ...
      - SHA-256 do bloco: `bd4c11af9ab4d8fef27ed62dd8520233c0b51dcc2fc25bade4ea232414fd97b0`
    - [SRC-S009 · L89–L100 · 1.6 Jurimetria — o pedido de maior valor e maior risco](#src-s009)
      - Caminho: 25 — Requisitos da FORJA extraídos da entrevista de Fábio Medina Osório > 1. O que ele efetivamente pediu > 1.6 Jurimetria — o pedido de maior valor e maior risco
      ...
      - SHA-256 do bloco: `aa6dd90dc504b24b9d35c508493652e95046d1e7d7c5f854db29d3d79f5842ba`
    - [SRC-S010 · L101–L108 · 1.7 Limites e postura que ele impôs sobre si](#src-s010)
      - Caminho: 25 — Requisitos da FORJA extraídos da entrevista de Fábio Medina Osório > 1. O que ele efetivamente pediu > 1.7 Limites e postura que ele impôs sobre si
      ...
      - SHA-256 do bloco: `51de97f85e5dc2485012bd6ad9aa73e0bfb85a25686163fb7669aa5590a5a733`
  - [SRC-S011 · L109–L112 · 2. Mapa de requisitos contra o harness real](#src-s011)
    - Caminho: 25 — Requisitos da FORJA extraídos da entrevista de Fábio Medina Osório > 2. Mapa de requisitos contra o harness real
    ...
    - SHA-256 do bloco: `2319df38fd5f1f83f67880f6d4a829c81682048b4a79b126a8d190dfe465bdde`
    - [SRC-S012 · L113–L132 · 2.1 O que já existe e atende (não reconstruir)](#src-s012)
      - Caminho: 25 — Requisitos da FORJA extraídos da entrevista de Fábio Medina Osório > 2. Mapa de requisitos contra o harness real > 2.1 O que já existe e atende (não reconstruir)
      ...
      - SHA-256 do bloco: `ca2a372de5e62f2e1526168456b2046886b76a3a4a90e3acee4720468b1c53e8`
    - [SRC-S013 · L133–L160 · 2.2 Lacunas confirmadas por varredura](#src-s013)
      - Caminho: 25 — Requisitos da FORJA extraídos da entrevista de Fábio Medina Osório > 2. Mapa de requisitos contra o harness real > 2.2 Lacunas confirmadas por varredura
      ...
      - SHA-256 do bloco: `1ad98f0025ed6cc12ea5bed159cd446edb8e5ce5808b5a29c9b1563b32b581e3`
  - [SRC-S014 · L161–L187 · 3. Avaliação dos três documentos externos](#src-s014)
    - Caminho: 25 — Requisitos da FORJA extraídos da entrevista de Fábio Medina Osório > 3. Avaliação dos três documentos externos
    - Assuntos: não, ele, três, dele, documentos, peça, lote, perguntas
    - Trecho-guia: Aproveitáveis, com três correções materiais.
    - SHA-256 do bloco: `f97413c1de44c3303ba6caf22f64e6da456602e52f2f62035a281f4a49b2aa0b`
  - [SRC-S015 · L188–L191 · 4. Padrões de pensamento e de linguagem dele](#src-s015)
    - Caminho: 25 — Requisitos da FORJA extraídos da entrevista de Fábio Medina Osório > 4. Padrões de pensamento e de linguagem dele
    ...
    - SHA-256 do bloco: `3d93a50f790a99f1d7be8fb3ccc5a8e45b62efaa7a8be4fc8b54ff98a97bcc0c`
    - [SRC-S016 · L192–L201 · 4.1 Padrões de fala (não transportar para o texto)](#src-s016)
      - Caminho: 25 — Requisitos da FORJA extraídos da entrevista de Fábio Medina Osório > 4. Padrões de pensamento e de linguagem dele > 4.1 Padrões de fala (não transportar para o texto)
      ...
      - SHA-256 do bloco: `ae40d9e1a786bde1249ad17b3c715ec7c2fd360a4df90ab2377c36c79ceb1afc`
    - [SRC-S017 · L202–L207 · 4.2 Léxico dele (vocabulário positivo, extraído literalmente)](#src-s017)
      - Caminho: 25 — Requisitos da FORJA extraídos da entrevista de Fábio Medina Osório > 4. Padrões de pensamento e de linguagem dele > 4.2 Léxico dele (vocabulário positivo, extraído literalmente)
      ...
      - SHA-256 do bloco: `5aa6993e4fe7d0b8a6aa8416decc71c29a47f1cd0bdf89da020b6baa0cdba0d6`
    - [SRC-S018 · L208–L234 · 4.3 Padrões cognitivos (estes são para codificar)](#src-s018)
      - Caminho: 25 — Requisitos da FORJA extraídos da entrevista de Fábio Medina Osório > 4. Padrões de pensamento e de linguagem dele > 4.3 Padrões cognitivos (estes são para codificar)
      ...
      - SHA-256 do bloco: `ccadcf86a331142f7e9cb808ea033905d384f89b210e504c5d613b60713fef45`
    - [SRC-S019 · L235–L247 · 4.4 Entrelinhas — o que ele quis dizer sem dizer](#src-s019)
      - Caminho: 25 — Requisitos da FORJA extraídos da entrevista de Fábio Medina Osório > 4. Padrões de pensamento e de linguagem dele > 4.4 Entrelinhas — o que ele quis dizer sem dizer
      ...
      - SHA-256 do bloco: `8b9302c08284c5947a520475006b707bc99f786a21b4492174b910ad514b7543`
  - [SRC-S020 · L248–L279 · 5. Plano de instalação proposto](#src-s020)
    - Caminho: 25 — Requisitos da FORJA extraídos da entrevista de Fábio Medina Osório > 5. Plano de instalação proposto
    ...
    - SHA-256 do bloco: `82ca515eed07e2b5392aecb70f396a52659b62f06e18de47d8ad2a95cdbfeecf`
  - [SRC-S021 · L280–L314 · 6. Registro de rastreabilidade](#src-s021)
    - Caminho: 25 — Requisitos da FORJA extraídos da entrevista de Fábio Medina Osório > 6. Registro de rastreabilidade
    ...
    - SHA-256 do bloco: `bc09ac771954351f79c856dc56b5f178f777df3d5c35ee5eb64e1c9290b80bd7`
