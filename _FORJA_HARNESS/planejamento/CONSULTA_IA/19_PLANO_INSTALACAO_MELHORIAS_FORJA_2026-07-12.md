# Consulta IA — 19 — Plano de instalação das melhorias mapeadas na FORJA

> Cópia de consulta derivada. O documento canônico permanece no caminho de origem indicado abaixo.

## Metadados e rastreabilidade

- **Documento de origem:** `19_PLANO_INSTALACAO_MELHORIAS_FORJA_2026-07-12.md`
- **Tipo:** Plano
- **SHA-256 da origem:** `81eea34a2b38284562063e74c5069eda2f9d5584a1a6ecac2b108fc799cfb0d6`
- **Linhas da origem:** 223
...
- [SRC-S001 · L1–L13 · 19 — Plano de instalação das melhorias mapeadas na FORJA](#src-s001)
  ...
  - SHA-256 do bloco: `82f5b46f066bbdc48f054a4df09052d06e12392158a70b744a6f016f46838e5d`
  - [SRC-S002 · L14–L35 · Sumário das lacunas e mapeamento para milestones](#src-s002)
    - Caminho: 19 — Plano de instalação das melhorias mapeadas na FORJA > Sumário das lacunas e mapeamento para milestones
    ...
    - SHA-256 do bloco: `677d96424d6cb7ed2ed204b4d8525589a916bef9ce8d139de242b35e27e90d65`
  - [SRC-S003 · L36–L37 · M1 — Observabilidade e contexto (estimativa: 6-8h)](#src-s003)
    - Caminho: 19 — Plano de instalação das melhorias mapeadas na FORJA > M1 — Observabilidade e contexto (estimativa: 6-8h)
    ...
    - SHA-256 do bloco: `9b0aaedb424d2813875920ced896d7a66587cf3fa504cd92cf37a32d602e2bf7`
    - [SRC-S004 · L38–L58 · M1.1 Alerta proativo de P0 (2-3h)](#src-s004)
      - Caminho: 19 — Plano de instalação das melhorias mapeadas na FORJA > M1 — Observabilidade e contexto (estimativa: 6-8h) > M1.1 Alerta proativo de P0 (2-3h)
      ...
      - SHA-256 do bloco: `3f741a2fd51dec1a1db002fd5946b50082adc9e4d98fa396152570ffdbf073d3`
    - [SRC-S005 · L59–L70 · M1.2 LocalContext da FORJA (hook de sessão) (1-2h)](#src-s005)
      - Caminho: 19 — Plano de instalação das melhorias mapeadas na FORJA > M1 — Observabilidade e contexto (estimativa: 6-8h) > M1.2 LocalContext da FORJA (hook de sessão) (1-2h)
      ...
      - SHA-256 do bloco: `05e51e941e2fa411afdaa3b0692d35a7c43db370656a9f66d368c2898062d1ad`
    - [SRC-S006 · L71–L85 · M1.3 Histórico de bloqueadores + tendência de gates (3h)](#src-s006)
      - Caminho: 19 — Plano de instalação das melhorias mapeadas na FORJA > M1 — Observabilidade e contexto (estimativa: 6-8h) > M1.3 Histórico de bloqueadores + tendência de gates (3h)
      ...
      - SHA-256 do bloco: `f5d6f34d6c118c15eea3d326975c0cda9e9f8116f53185a3f68a71a673838a51`
  - [SRC-S007 · L86–L87 · M2 — Ordem dos pareceres Helena/Cícero (estimativa: 3-4h)](#src-s007)
    - Caminho: 19 — Plano de instalação das melhorias mapeadas na FORJA > M2 — Ordem dos pareceres Helena/Cícero (estimativa: 3-4h)
    ...
    - SHA-256 do bloco: `223a4773430d8508c9ac023e1ab31b96d706ef3e31216abe03a15e298fd0b843`
    - [SRC-S008 · L88–L110 · M2.1 Pareceres ANTES da redação (ordem do Igor 09/07, lição 62)](#src-s008)
      - Caminho: 19 — Plano de instalação das melhorias mapeadas na FORJA > M2 — Ordem dos pareceres Helena/Cícero (estimativa: 3-4h) > M2.1 Pareceres ANTES da redação (ordem do Igor 09/07, lição 62)
      ...
      - SHA-256 do bloco: `cd51d3e07efdf16debff37e113012c919272ff82ebed6e44238446998d2cdf32`
  - [SRC-S009 · L111–L112 · M3 — Caminho crítico da promoção N4 (estimativa: 20-30h + casos reais)](#src-s009)
    - Caminho: 19 — Plano de instalação das melhorias mapeadas na FORJA > M3 — Caminho crítico da promoção N4 (estimativa: 20-30h + casos reais)
    ...
    - SHA-256 do bloco: `8b549b8926c6f0e270ccd79adadec30fa2d0c6294d0d3deb99e55bb9a94041ed`
    - [SRC-S010 · L113–L145 · M3.1 Mutação semântica (12-16h) — maior lacuna técnica](#src-s010)
      - Caminho: 19 — Plano de instalação das melhorias mapeadas na FORJA > M3 — Caminho crítico da promoção N4 (estimativa: 20-30h + casos reais) > M3.1 Mutação semântica (12-16h) — maior lacuna técnica
      ...
      - SHA-256 do bloco: `0e78a8e5f121fba552e52fc5b77f354844fc49ec73895de1a77370222514f7c4`
    - [SRC-S011 · L146–L163 · M3.2 Ledger de citações materiais (6-8h) — lição 52](#src-s011)
      - Caminho: 19 — Plano de instalação das melhorias mapeadas na FORJA > M3 — Caminho crítico da promoção N4 (estimativa: 20-30h + casos reais) > M3.2 Ledger de citações materiais (6-8h) — lição 52
      ...
      - SHA-256 do bloco: `c2aeba3b99a92d64186d07173d6bd09b104a43c75bf0eb2f4c222aaf9116a5db`
    - [SRC-S012 · L164–L183 · M3.3 Três ciclos prospectivos (processo, não código — 2h de preparação)](#src-s012)
      - Caminho: 19 — Plano de instalação das melhorias mapeadas na FORJA > M3 — Caminho crítico da promoção N4 (estimativa: 20-30h + casos reais) > M3.3 Três ciclos prospectivos (processo, não código — 2h de preparação)
      ...
      - SHA-256 do bloco: `83345d34e83095522414813f1a3152f2d0c35405c54f4c1861a849ebc09c5808`
  - [SRC-S013 · L184–L185 · M4 — Robustez contínua (estimativa: 8-12h, paralelizável)](#src-s013)
    - Caminho: 19 — Plano de instalação das melhorias mapeadas na FORJA > M4 — Robustez contínua (estimativa: 8-12h, paralelizável)
    ...
    - SHA-256 do bloco: `3fc32a493cc0bf2fa7b2666fe96f1157564430ee036192c0bd7153ae8633dd3e`
    - [SRC-S014 · L186–L190 · M4.1 Suite de teste para forjarun.py (3-4h)](#src-s014)
      - Caminho: 19 — Plano de instalação das melhorias mapeadas na FORJA > M4 — Robustez contínua (estimativa: 8-12h, paralelizável) > M4.1 Suite de teste para forjarun.py (3-4h)
      ...
      - SHA-256 do bloco: `a14554e4f9138a81bb39747130e0803618ba4f35de5c53a7bcd0cf494efa9a74`
    - [SRC-S015 · L191–L198 · M4.2 F8 — ampliar QA visual automático (3-4h)](#src-s015)
      - Caminho: 19 — Plano de instalação das melhorias mapeadas na FORJA > M4 — Robustez contínua (estimativa: 8-12h, paralelizável) > M4.2 F8 — ampliar QA visual automático (3-4h)
      ...
      - SHA-256 do bloco: `9ffb4fb90ce1161bf7764e319a67c8e2c3b704501904457a756673a902698861`
    - [SRC-S016 · L199–L206 · M4.3 F2 — classificação assistida (2-3h)](#src-s016)
      - Caminho: 19 — Plano de instalação das melhorias mapeadas na FORJA > M4 — Robustez contínua (estimativa: 8-12h, paralelizável) > M4.3 F2 — classificação assistida (2-3h)
      ...
      - SHA-256 do bloco: `4c5ffdc12dc4530467b95e139cdca492474d139d1ebcdf25ce8db52faa37c52f`
  - [SRC-S017 · L207–L223 · Cronograma e dependências](#src-s017)
    - Caminho: 19 — Plano de instalação das melhorias mapeadas na FORJA > Cronograma e dependências
    ...
    - SHA-256 do bloco: `f7df69e63209e291126dbb86c35ca2ead2f3a9d89453d2ab70024a3cc460e5d8`
