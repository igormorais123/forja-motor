# Consulta IA — 26 — Arquitetura de três eixos: dialética com o advogado, identidade Medina Osório e sistema de precedentes

> Cópia de consulta derivada. O documento canônico permanece no caminho de origem indicado abaixo.

## Metadados e rastreabilidade

- **Documento de origem:** `30_ARQUITETURA_DIALETICA_IDENTIDADE_E_PRECEDENTES.md`
- **Tipo:** Documento de planejamento
- **SHA-256 da origem:** `456654d092b648838a97e2e579799c3a627709cc2ba747353a00ec4b074e1c54`
- **Linhas da origem:** 409
- **Blocos integralmente indexados:** 30
...
- [SRC-S001 · L1–L9 · 26 — Arquitetura de três eixos: dialética com o advogado, identidade Medina Osório e sistema de precedentes](#src-s001)
  ...
  - SHA-256 do bloco: `8110a5a46c4d0f7c1f21b5fe7dbd5d143203a93b580f58dd2ca13ecf2ec70617`
  - [SRC-S002 · L10–L26 · 0. Resolução de uma divergência entre os pareceres](#src-s002)
    - Caminho: 26 — Arquitetura de três eixos: dialética com o advogado, identidade Medina Osório e sistema de precedentes > 0. Resolução de uma divergência entre os pareceres
    ...
    - SHA-256 do bloco: `e8bce1e66ec4f1c31ab8959bd7ec971ff6bb4499ab404339b982dbf314ad21ff`
    - [SRC-S003 · L27–L42 · 0.1 Correções do Codex que este documento adota — e que corrigem o documento 25](#src-s003)
      - Caminho: 26 — Arquitetura de três eixos: dialética com o advogado, identidade Medina Osório e sistema de precedentes > 0. Resolução de uma divergência entre os pareceres > 0.1 Correções do Codex que este documento adota — e que corrigem o documento 25
      ...
      - SHA-256 do bloco: `2b9800840f148d3cc20e69d9607cd01342cd25f766f663651306141c6591c5b8`
- [SRC-S004 · L43–L44 · PARTE I — A dialética: o sistema como parceiro intelectual antes de escrever](#src-s004)
  ...
  - SHA-256 do bloco: `e9bd50ce251297ef3e3755f4aa1c45e38fb637a71524ad3a3a46d22f09b4c981`
  - [SRC-S005 · L45–L52 · 1.1 O que precisa ficar claro antes de projetar](#src-s005)
    - Caminho: PARTE I — A dialética: o sistema como parceiro intelectual antes de escrever > 1.1 O que precisa ficar claro antes de projetar
    ...
    - SHA-256 do bloco: `3a0cc6efaf1105412f23738edf01fc30b83c703e7b926239f6f70ffa516c6db7`
  - [SRC-S006 · L53–L87 · 1.2 O instrumento: CONSULTA AO ADVOGADO RESPONSÁVEL](#src-s006)
    - Caminho: PARTE I — A dialética: o sistema como parceiro intelectual antes de escrever > 1.2 O instrumento: CONSULTA AO ADVOGADO RESPONSÁVEL
    ...
    - SHA-256 do bloco: `f3c6c2fc381ee9ef4f307f77b379d31109ea7e055739556f2973f2b197a3da94`
  - [SRC-S007 · L88–L98 · 1.3 A regra que protege a confiança](#src-s007)
    - Caminho: PARTE I — A dialética: o sistema como parceiro intelectual antes de escrever > 1.3 A regra que protege a confiança
    ...
    - SHA-256 do bloco: `5e783caf566300624480a8cc6386b40b56c70ab0e43ba2e29aee52e29fe72e80`
  - [SRC-S008 · L99–L108 · 1.4 Por que isto é barato: o motor já existe](#src-s008)
    - Caminho: PARTE I — A dialética: o sistema como parceiro intelectual antes de escrever > 1.4 Por que isto é barato: o motor já existe
    ...
    - SHA-256 do bloco: `c36128d6f6a9f0956db1dcc3e3ae0ca4f57d2881019eedf67b22c1ade5e84d53`
  - [SRC-S009 · L109–L114 · 1.5 Teses: cobertura, não contagem](#src-s009)
    - Caminho: PARTE I — A dialética: o sistema como parceiro intelectual antes de escrever > 1.5 Teses: cobertura, não contagem
    ...
    - SHA-256 do bloco: `8ebadef81ea20a529a29fec6eab344041483e2d3c10ff3a24fd836475db858fe`
  - [SRC-S010 · L115–L122 · 1.6 Onde isto mora no harness](#src-s010)
    - Caminho: PARTE I — A dialética: o sistema como parceiro intelectual antes de escrever > 1.6 Onde isto mora no harness
    ...
    - SHA-256 do bloco: `4a53ef3e8d09d86791742b0f45d1511e8cde4fd3516449fbdd3fb34b93c113dc`
- [SRC-S011 · L123–L124 · PARTE II — Identidade Medina Osório: método antes de vocabulário](#src-s011)
  ...
  - SHA-256 do bloco: `d5d8990856b77d436b020dfce639c12da61a2d53588053c1534ae8f289b2d1c9`
  - [SRC-S012 · L125–L141 · 2.1 O diagnóstico honesto do corpus](#src-s012)
    - Caminho: PARTE II — Identidade Medina Osório: método antes de vocabulário > 2.1 O diagnóstico honesto do corpus
    ...
    - SHA-256 do bloco: `e8f68e74db96bde30cfb1529ca633440fe78b4ac150ee59f77e89138fead93f0`
  - [SRC-S013 · L142–L153 · 2.2 Três níveis de confiança, e só dois são ativáveis](#src-s013)
    - Caminho: PARTE II — Identidade Medina Osório: método antes de vocabulário > 2.2 Três níveis de confiança, e só dois são ativáveis
    ...
    - SHA-256 do bloco: `4f775c97cd480b18183e50e6bad4f15b9b91ab9b2c9896e60037e811c61b4841`
  - [SRC-S014 · L154–L170 · 2.3 O que já é N1 hoje, sem pedir nada a ele](#src-s014)
    - Caminho: PARTE II — Identidade Medina Osório: método antes de vocabulário > 2.3 O que já é N1 hoje, sem pedir nada a ele
    ...
    - SHA-256 do bloco: `a2608f1e815f2a1b96534c8438093f0261c0fd41c5ae53f8808c5bf871801a10`
  - [SRC-S015 · L171–L194 · 2.4 A identidade que importa é o motor argumentativo](#src-s015)
    - Caminho: PARTE II — Identidade Medina Osório: método antes de vocabulário > 2.4 A identidade que importa é o motor argumentativo
    ...
    - SHA-256 do bloco: `8cbb07d08567eb50e2895701cb9a8374de443e7f9bcc07b950d08bd1ee66130e`
  - [SRC-S016 · L195–L208 · 2.5 O que extrair, em que ordem, e o que não extrair](#src-s016)
    - Caminho: PARTE II — Identidade Medina Osório: método antes de vocabulário > 2.5 O que extrair, em que ordem, e o que não extrair
    ...
    - SHA-256 do bloco: `5a2eb31a3074c74342517f1b730c06d0d8cea15aa534cde83c85c1c3c81c905e`
  - [SRC-S017 · L209–L218 · 2.6 Validação: o alvo correto](#src-s017)
    - Caminho: PARTE II — Identidade Medina Osório: método antes de vocabulário > 2.6 Validação: o alvo correto
    ...
    - SHA-256 do bloco: `9020a4475f0c652647438ed7fb3a28dc91481556f991e7109348ddf0bde51528`
- [SRC-S018 · L219–L222 · PARTE III — O sistema de precedentes: onde a FORJA está mais aquém](#src-s018)
  ...
  - SHA-256 do bloco: `c4f781a3969899287e76a1e07b763e2aa3ec447dbc3447f8101479ecf2eaabcc`
  - [SRC-S019 · L223–L241 · 3.1 O achado que muda o custo do projeto](#src-s019)
    - Caminho: PARTE III — O sistema de precedentes: onde a FORJA está mais aquém > 3.1 O achado que muda o custo do projeto
    ...
    - SHA-256 do bloco: `9bd7dbe5ba3f0b2c38d677af482412801553f94b45c448ee82b522ff2d372afe`
  - [SRC-S020 · L242–L265 · 3.2 Camada 1 — Topologia decisória (subfase F3-B)](#src-s020)
    - Caminho: PARTE III — O sistema de precedentes: onde a FORJA está mais aquém > 3.2 Camada 1 — Topologia decisória (subfase F3-B)
    ...
    - SHA-256 do bloco: `a83ca1e064d84ad24666bb49e812bc2eed4193fb9e7a047e99e9750885418f9f`
  - [SRC-S021 · L266–L303 · 3.3 Camada 2 — A ficha de precedente (subfase F5-B)](#src-s021)
    - Caminho: PARTE III — O sistema de precedentes: onde a FORJA está mais aquém > 3.3 Camada 2 — A ficha de precedente (subfase F5-B)
    ...
    - SHA-256 do bloco: `28ffb051de9856fa0de151359a887070f3a81c156676db3f3043a4d58faea0fb`
  - [SRC-S022 · L304–L334 · 3.4 Camada 2-B — Seleção estratégica: a jurimetria que dá para fazer já](#src-s022)
    - Caminho: PARTE III — O sistema de precedentes: onde a FORJA está mais aquém > 3.4 Camada 2-B — Seleção estratégica: a jurimetria que dá para fazer já
    ...
    - SHA-256 do bloco: `8127c07a2fe33c548ac85df56b18d1f0c4d9ccfd877c62c39c29892ff6beb734`
  - [SRC-S023 · L335–L350 · 3.5 Camada 3 — Auditabilidade da própria pesquisa](#src-s023)
    - Caminho: PARTE III — O sistema de precedentes: onde a FORJA está mais aquém > 3.5 Camada 3 — Auditabilidade da própria pesquisa
    ...
    - SHA-256 do bloco: `5518790c859ccce43ec0a06ce40a13bdaa5907be59899d745b33f343729874eb`
  - [SRC-S024 · L351–L356 · 3.6 Precedente administrativo](#src-s024)
    - Caminho: PARTE III — O sistema de precedentes: onde a FORJA está mais aquém > 3.6 Precedente administrativo
    ...
    - SHA-256 do bloco: `a3e83de2f623cbb09ee8bb5f71c18d4f3a1aaa064e40356f665619cfc234e32b`
  - [SRC-S025 · L357–L372 · 3.7 Gates novos que decorrem, e o que eles impedem](#src-s025)
    - Caminho: PARTE III — O sistema de precedentes: onde a FORJA está mais aquém > 3.7 Gates novos que decorrem, e o que eles impedem
    ...
    - SHA-256 do bloco: `e8b8015f0417ca21ca3be1b27cf06722da9d50c20fd0ca448d7e249ae4dd1ed1`
- [SRC-S026 · L373–L374 · PARTE IV — Sequenciamento e o que depende dele](#src-s026)
  ...
  - SHA-256 do bloco: `0b885c448c6da25cf0f5920c9986ba5108ff82d11f30dc61a328b9e5f5d3bc40`
  - [SRC-S027 · L375–L386 · 4.1 Ordem proposta](#src-s027)
    - Caminho: PARTE IV — Sequenciamento e o que depende dele > 4.1 Ordem proposta
    ...
    - SHA-256 do bloco: `717be3ea233f99885a479bdb025981e15f37ee1220d33912465dea57134cc890`
  - [SRC-S028 · L387–L394 · 4.2 O que só ele pode dar](#src-s028)
    - Caminho: PARTE IV — Sequenciamento e o que depende dele > 4.2 O que só ele pode dar
    ...
    - SHA-256 do bloco: `19bfdc00f1e148b5849e82fb76528b0ac1d22c4a34e543ed59af6107d67a9f1d`
  - [SRC-S029 · L395–L402 · 4.3 Como apresentar](#src-s029)
    - Caminho: PARTE IV — Sequenciamento e o que depende dele > 4.3 Como apresentar
    ...
    - SHA-256 do bloco: `3ef7c0b0dfd0d72f09147fec9cd92eba5c97491de2ba67e3dbe0d58450bb91b9`
  - [SRC-S030 · L403–L409 · 4.4 Riscos deste plano, declarados](#src-s030)
    - Caminho: PARTE IV — Sequenciamento e o que depende dele > 4.4 Riscos deste plano, declarados
    ...
    - SHA-256 do bloco: `5d4950de49ca56bdb27205958c2d31e198d1ca044577847d684a94d7a6da5e6d`
