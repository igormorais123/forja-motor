...
- Escreva o entregável COMPLETO no arquivo `C:\Users\IgorPC\.claude\projects\Escritório fabio osório\fabricas de melhoria de petições\_FORJA_HARNESS\autoresearch\ciclos\ciclo-2\exec2\OUT_e3.md` e nada em nenhum outro arquivo. Não use o nome do arquivo como título nem o mencione no texto. Não leia nenhum arquivo do disco: todo o material necessário está neste prompt.
