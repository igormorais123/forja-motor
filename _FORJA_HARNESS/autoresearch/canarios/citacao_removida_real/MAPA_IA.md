...
```mermaid
flowchart TD
  N2fff369561["citacao_removida_real<br/>pasta auxiliar<br/>4 arquivos / 0 subpastas"]
  Nb9727ab6ef["subir: canarios"]
  N2fff369561 --> Nb9727ab6ef
  click Nb9727ab6ef "../MAPA_IA.md" "Abrir mapa superior"
  Nb9e9738acd["README.md<br/>instruções locais da pasta"]
  N2fff369561 --> Nb9e9738acd
  click Nb9e9738acd "README.md" "Abrir arquivo"
```
