...
CLASSIFICACAO = [
    ...
    ("MOTOR_DISTRIBUICAO.md", fr.MOTOR, "contrato genérico compartilhável"),
    ("GITHUB_BACKUP_README.md", fr.ACERVO,
     "documentação privada da instalação e dos destinos locais"),
