...
|---|---:|---|---|---|---|
| CASO-08 — áudio indicado como fundamental sem arquivo acessível | P1 | aberto/bloqueado | evento de áudio existe, mas não há mídia materializada no acervo consultado | `MC-01`, `MC-08`, G2 | obter reenvio/recuperação, transcrever e confrontar com o parecer |
...
- inspeção visual do painel e do detalhe CASO-08: aprovada;
